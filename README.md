...
![AI](https://img.shields.io/badge/AI-Anthropic_%7C_OpenAI_%7C_xAI-8b5cf6?style=flat)
...
- **Demo mode** — no TWS? Try the full dashboard against a built-in sample portfolio without any IBKR connection.
...
Set `DEMO_MODE=1` before launching:
